function avgAoI = getAoI_FCFS_GE(p,r,lambda)
%This file is created by Xu Xiaoli on 23/09/2021
%It simlate the AoI performance of FCFC policy with instant feedback and GE
%channel
...
P_G = 0.2;
P_B = 0.8;
transitOK_G = rand(1,N) < P_G;
transitOK_B = rand(1,N) < P_B;
transitOK = zeros(1, N);
for i = 1 : N
    if transitOK_G(i) == 1 && GoodState(i) == 1
        transitOK(i) = 1;
    elseif transitOK_B(i) == 1 && GoodState(i) == 0
        transitOK(i) = 1;
    end
end
GoodState = transitOK;
